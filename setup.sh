...
if [[ `uname` == 'Linux' ]]; then
    ...
    export SHA256="750a07fef8579ae4839458701f4df690e0b20b8bcce33b437e4df89c451b6f13"
else
    export TAR="$VERSION.darwin-amd64.tar.gz"
    export SHA256="6c7e07349403f71588ef4e93a6d4ae31f8e5de1497a0a42fd998fe9b6bd07c8e"
fi
