...
if [[ `uname` == 'Linux' ]]; then
    ...
    export SHA256="3924819eed16e55114f02d25d03e77c916ec40b7fd15c8acb5838b63135b03df"
else
    export TAR="$VERSION.darwin-amd64.tar.gz"
    export SHA256="edb7aad4607509e3eb9f8bd3b43fb9c419b4a007874a9f6e2f99c541411f9304"
fi
