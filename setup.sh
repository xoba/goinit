...
if [[ `uname` == 'Linux' ]]; then
    ...
    export SHA256="d20a4869ffb13cee0f7ee777bf18c7b9b67ef0375f93fac1298519e0c227a07f"
else
    export TAR="$VERSION.darwin-amd64.tar.gz"
    export SHA256="3d164d44fcb06a4bbd69d19d8d91308d601f7d855a1037346389644803fdf148"
fi
